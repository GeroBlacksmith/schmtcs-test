...
@Component({
  selector: 'app-Agro-carousel',
  templateUrl: './Agro-carousel.component.html',
  styleUrls: ['./Agro-carousel.component.scss']
})
export class AgroCarouselComponent implements OnInit {
